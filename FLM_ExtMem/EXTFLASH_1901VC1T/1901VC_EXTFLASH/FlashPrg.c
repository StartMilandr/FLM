...
/*               for 1901VC1T External Flash 1636PP1                  */
...
//Init clock: RST_CLK| PORTA | PORTB | PORTC | PORTE | PORTF | EXT_BUS_CNTRL 
  ...
  PORTC_OE = 0x00;
	...
	PORTC_FUNC = 0x14;       // PORTC9 - FUNC=00 -> PORT(HI-Z), PORTC1 = nOE, PORTC2 = nWE
	PORTE_FUNC = 0x10000055; // PORTE[0:3] = A[16:A19], PORTE14 - nCE
	PORTF_FUNC = 0x55555550; // PORTF[2:15] - A[2:15]
