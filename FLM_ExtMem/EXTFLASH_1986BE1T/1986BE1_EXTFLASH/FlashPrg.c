...
/*               for 1986VE1T External Flash 1636PP1                  */
...
#define PORTD_RXTX 		(*((volatile unsigned int *) 0x400c0000))
#define PORTD_OE	 		(*((volatile unsigned int *) 0x400c0004))
#define PORTD_FUNC	 	(*((volatile unsigned int *) 0x400c0008))
#define PORTD_ANALOG	(*((volatile unsigned int *) 0x400c000C))
#define PORTD_PULL	 	(*((volatile unsigned int *) 0x400c0010))
#define PORTD_PD	 		(*((volatile unsigned int *) 0x400c0014))
#define PORTD_PWR	 		(*((volatile unsigned int *) 0x400c0018))
...
//Init clock: RST_CLK| PORTA | PORTB | PORTC | PORTD | PORTE | PORTF | EXT_BUS_CNTRL 
	PER_CLOCK = (1<<4) |(1<<21)|(1<<22)|(1<<23)|(1<<24)|(1<<25)|(1<<29)|(1<<30);

	PORTA_FUNC = 0x55555555; //PORTA=D0-D15
	PORTB_FUNC = 0x55555555; //PORTB=D16-D31
	PORTC_FUNC = 0x5;        //PORTC[1:0]=OE, WE
	PORTD_FUNC = 0x80000000; //PORTD[15]=A13
	PORTE_FUNC = 0x20AAA;    //PORTE[0:5]=A14-A19, PORTE[8]nCE
	PORTF_FUNC = 0xAAAAA800; //PORTF[5:15]=A2-A12
  ...
  PORTF_ANALOG = 0xFFE0;
	...
	PORTC_PWR = 0xF;
	PORTD_PWR =	0xC0000000;
	PORTE_PWR = 0x30FFF;
	PORTF_PWR = 0xFFFFFC00;
